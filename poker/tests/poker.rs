...
#[test]
fn test_same_ranks_are_equal() {
    assert_eq!(poker::Rank::Two.cmp(&poker::Rank::Two), Ordering::Equal);
    assert_eq!(poker::Rank::King.cmp(&poker::Rank::King), Ordering::Equal);
}

#[test]
fn higher_ranks_are_higher() {
    assert_eq!(poker::Rank::Three.cmp(&poker::Rank::Two), Ordering::Greater);
    assert_eq!(poker::Rank::King.cmp(&poker::Rank::Ten), Ordering::Greater);
}

#[test]
fn lower_ranks_are_higher() {
    assert_eq!(poker::Rank::Two.cmp(&poker::Rank::Three), Ordering::Less);
    assert_eq!(poker::Rank::Ten.cmp(&poker::Rank::King), Ordering::Less);
}
